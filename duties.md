...
- [x] 2026-06-12 — [command] Enable the Pipe daemon persistently: systemctl --user enable --now antcrated  (daemon verified working 2026-06-12 via direct-run smoke — tree.mmd auto-regen fired on friendly_cars touch; enable/start is control-plane, gateway-blocked for agents) (done 2026-06-12)

# AntCrate — State Archive

Retired top-of-mind blocks from `state.md`, moved here verbatim when they age out of the rolling window. Append-only, newest first. Full decision history lives in `ledger.md`; this file preserves the session-by-session narrative context.
...
- Plan written + landed by user as TH command-duty 2026-06-12 (`docs/plans/2026-06-11-least-cost-allocation-and-skill-scoping.md`) → **EXECUTED, see ledger 2026-06-12.**
